...
public class ChatActivity extends AppCompatActivity {
    ...
    private void sendCloudMessage(chatMessage m) {
        String serverKey = "AAAAZTHdITw:APA91bE-n29-ItMh4bVS-bZEwiYUASuu7gH0T2rp1XM3i_ldxPOReQRUNfJkH5q5MhSnXZx_bUK5BrmHvYjLE9jnG5YoEbCU4kBV9GmIuSUcwnwmlig8yRxuYL2Rt_jgj4Tw9O1A8xHq";
        String topic = "chat";
